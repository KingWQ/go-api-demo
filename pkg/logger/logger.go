...
// LogIf 当err != nil 时记录 error 等级的日志
...
// LogWarnIf 当err != nil 时记录 warning 等级的日志
...
// LogInfoIf 当err != nil 时记录 info 等级的日志
...
// Fatal 级别同Error()，写完log后调用 os.Exit(1) 退出程序
...
// DebugJSON 记录对象类型的debug日志， 使用json.Marshal进行编码
...
func jsonString(value interface{}) string {
	...
	if err != nil {
		Logger.Error("Logger", zap.String("JSON marshal err", err.Error()))
	}
	return string(b)
}
